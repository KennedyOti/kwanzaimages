...
@section('content')
    <div class="page-inner">
        ...
        <div class="row">
            ...
            @else
                <h1 style="text-align: center">Welcome To The News User Portal</h1>
                <br><br>
                <p style="text-align: center">This Portal is still under development for any enquries kindly logout fill
                    the
